...
import { Save, Users, Bell, User as UserIcon, Shield, LayoutGrid, AlertCircle } from "lucide-react";
...
export default function SettingsPage() {
  const { user, roles, setUserRole, notificationSettings, setNotificationSettings } = useUser();
                ...
                <CardContent className="px-4 md:px-6">
                    <form className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="login" defaultValue={user.email} readOnly className="cursor-not-allowed focus-visible:ring-0 focus-visible:ring-offset-0 bg-slate-100 dark:bg-slate-800" />
                        </div>
                        <div className="space-y-2">
